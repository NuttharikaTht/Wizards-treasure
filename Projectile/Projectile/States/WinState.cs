...
namespace Projectile.States
{
    class WinState : State
    {
        ...
        public WinState(Main game, GraphicsDevice graphicsDevice, ContentManager content, String path)
          : base(game, graphicsDevice, content)
        {
            bg_win = _content.Load<Texture2D>("GameState/"+path);
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            Globals.spriteBatch.Draw(bg_win, new Vector2(307, 141), Color.White);
